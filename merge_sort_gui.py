...
def merge_outer(root, collection, canvas, startIndex,  callBackFunction, timeLapse = 1000):
    ...
    if len(collection) <= 1:
        ...
        merge_outer(root, left_half, canvas, startIndex, lambda data : merge_outer(root, right_half, canvas, startIndex + midpoint, lambda data1 : merge_sorter(root, collection, canvas, k, i, j, data, data1, callBackFunction, timeLapse), timeLapse))
